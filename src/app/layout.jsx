        ...
        <html lang="es">
            <body className="">
                ...
                <div className="fixed inset-0 z-[-2] bg-slate-950/40">
                    <div ref={ellipse1} className="absolute top-[0%] right-[0%] w-[90px] aspect-[2/3] bg-slate-100 blur-[200px] rounded-full"></div>
                    <div ref={ellipse2} className="absolute bottom-[0%] left-[0%] w-[90px] aspect-[2/3] bg-slate-100 blur-[200px] rounded-full"></div>
                </div>
