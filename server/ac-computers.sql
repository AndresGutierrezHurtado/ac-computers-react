...
('3f66861c-27f6-49b8-89ff-a923a6377229', 'Workstation Creator Pro', 'Estación de trabajo para edición de video y diseño 3D.', '/images/products/default.jpg', 7500000, 1),
('456887fd-9955-45ff-9399-121e81600842', 'PC Oficina Smart', 'PC eficiente para tareas de oficina y productividad.', '/images/products/default.jpg', 2000000, 1),
('fdb62e9e-eb77-457d-ac80-e79871c6b6c6', 'PC Gamer Alpha', 'PC gamer con enfriamiento líquido y rendimiento extremo.', '/images/products/default.jpg', 5500000, 1),
('63f5737c-4d00-4689-a054-f1b4265eaadf', 'PC Diseño Gráfico Visionary', 'Computador especializado para diseñadores y editores.', '/images/products/default.jpg', 6200000, 1),
('a6709bce-e0fe-4326-b83a-5ab75a1698fe', 'PC Gamer NitroX', 'PC gamer de alto rendimiento con componentes de última generación.', '/images/products/default.jpg', 4500000, 1),
('dee80ac7-201d-4645-bd9f-c1ba43d3d143', 'Servidor NAS Pro', 'Servidor de almacenamiento para entornos empresariales.', '/images/products/default.jpg', 6800000, 1),
...
-- Components
('14e89a1f-7158-4715-b4b9-5e5171f98da9', 'Caja ATX NZXT H510', 'Chasis compacto y minimalista para PC.', '/images/products/default.jpg', 500000, 2),
('2295b1cb-fa65-4086-a00e-49358c0d5013', 'Disco Duro SSD Samsung 970 EVO Plus 1TB', 'Disco SSD NVMe para almacenamiento rápido.', '/images/products/default.jpg', 750000, 2),
('50890f7f-ed2b-4ba2-b77c-83f0b4d40f02', 'Memoria RAM Corsair Vengeance 16GB', 'Memoria RAM DDR4 de 16GB para alto rendimiento.', '/images/products/default.jpg', 400000, 2),
('8930d24c-1c6a-4c6f-8b37-cbd5a9513e7a', 'Tarjeta gráfica NVIDIA RTX 3060', 'Tarjeta gráfica con 12GB GDDR6, ideal para gaming y diseño.', '/images/products/default.jpg', 2100000, 2),
('8c67d0b6-48ce-4e37-8b1d-fbc01f58d944', 'Procesador Intel Core i7 12700K', 'Procesador de 12 núcleos, ideal para alto rendimiento.', '/images/products/default.jpg', 1800000, 2),
('9ee4191b-62c1-486a-901a-9fe5318ede73', 'Tarjeta de sonido Creative Sound BlasterX', 'Tarjeta de sonido para audio de alta fidelidad.', '/images/products/default.jpg', 350000, 2),
('a754dd9d-b11d-40c6-bded-a22b9fece258', 'Monitor Gaming LG Ultragear 27\'\'', 'Monitor IPS con resolución QHD y 144Hz.', '/images/products/default.jpg', 1300000, 2),
('a942bb25-3c28-4961-88dd-4bab9540aa7f', 'Placa Madre ASUS ROG STRIX Z690', 'Placa madre compatible con Intel de 12ª generación.', '/images/products/default.jpg', 1500000, 2),
('beb98e2c-0357-410c-b9e5-f67948851ded', 'Refrigeración Líquida Corsair H100i', 'Sistema de enfriamiento líquido para CPU.', '/images/products/default.jpg', 800000, 2),
('cc1a44d9-3e9e-4ea7-a2f8-bdfa84c0433f', 'Fuente de poder Corsair 750W', 'Fuente de poder modular de 750W, certificación 80 Plus Gold.', '/images/products/default.jpg', 600000, 2);
